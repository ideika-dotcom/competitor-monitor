...
const ui = {
    ...
    renderTextAnalysis(analysis) {
        return `
            <!-- Новые оценки в строительной нише -->
            <div class="scores-grid">
                <div class="score-card">
                    <div class="score-title">Оценка дизайна</div>
                    <div class="score-badge badge-design">${analysis.design_score || 0}/10</div>
                </div>
                <div class="score-card">
                    <div class="score-title">Потенциал анимации</div>
                    <div class="score-badge badge-animation">${analysis.animation_potential || 0}/10</div>
                </div>
                <div class="score-card">
                    <div class="score-title">Конверсия (потенциал)</div>
                    <div class="score-badge badge-conversion">${analysis.conversion_potential || 0}/10</div>
                </div>
                <div class="score-card">
                    <div class="score-title">Уровень доверия</div>
                    <div class="score-badge badge-trust">${analysis.trust_score || 0}/10</div>
                </div>
            </div>
            ...
            ${this.renderResultBlock('Уникальные предложения (УТП)', analysis.unique_offers, 'unique')}
            ${this.renderResultBlock('Рекламные гипотезы', analysis.ad_hypotheses, 'hypotheses')}
            ${this.renderResultBlock('Рекомендации по улучшению', analysis.recommendations, 'recommendations')}
    ...
    renderImageAnalysis(analysis) {
        return `
            ...
            <div class="scores-grid">
                <div class="score-card">
                    <div class="score-title">Оценка дизайна</div>
                    <div class="score-badge badge-design">${analysis.design_score || analysis.visual_style_score || 0}/10</div>
                </div>
                <div class="score-card">
                    <div class="score-title">Потенциал анимации</div>
                    <div class="score-badge badge-animation">${analysis.animation_potential || 0}/10</div>
    ...
    renderParsedContent(data) {
        ...
        return `
            <div class="parsed-content">
                ...
                <div class="value">${parsed.meta_description || 'Не найден'}</div>
                
                <div class="label">H1 (Главный заголовок):</div>
                <div class="value">${parsed.h1 || 'Не найден'}</div>
                
                <div class="label">Текстовая выжимка:</div>
                <div class="value text-preview">${parsed.body_text || parsed.first_paragraph || 'Не найден'}</div>
            </div>
    ...
    renderResultBlock(title, items, type) {
        ...
        const icons = {
            ...
            hypotheses: '<circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>'
        };
